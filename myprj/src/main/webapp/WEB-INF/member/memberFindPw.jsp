...
<head>
  ...
  function check() {
	  ...
	  fm.action="${pageContext.request.contextPath}/member/memberFindPwAction.do";
	  fm.method="post";
	  fm.submit();
 ...
 <%@ include file="/WEB-INF/header.jsp" %>
   ...
   <div class="d-flex align-items-center justify-content-between mb-4">
    ...
    <!-- 컨텐츠 -->     
    <div class="findpw w-100 m-auto align-items-center">
      <form name="frm">
        <div class="mb-3">
        ...
        <button class="btn btn-primary w-100 py-2 mt-1" type="button" onClick="check()">비밀번호 찾기</button>
      </form>
    </div>
