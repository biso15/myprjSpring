...
<div class="container d-flex flex-column">    
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
      ...
      <nav aria-label="breadcrumb">
        ...
        <ol class="breadcrumb breadcrumb-chevron p-3 justify-content-end">
          ...
          <li class="breadcrumb-item active" aria-current="page">당일치기</li>
        </ol>
      </nav>
    </div>
    ...
    <div class="d-flex justify-content-between">
      <a herf="${pageContext.request.contextPath}/board/travel/1/boardWrite.do" class="btn btn-outline-primary">글쓰기</a>
    ...
    <div class="album py-5">
      <div class="row row-cols-md-4 g-3">
        ...
        <a class="col" href="${pageContext.request.contextPath}/board/boardContents.do?bidx=${bv.bidx}">
